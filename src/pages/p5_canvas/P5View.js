...
export default function P5View({ isVisible }) {
  return (
    <div className="p5-view">
      ...
      <P5Canvas sketch={planeSketch} width={200} height={200} left={1200} top={400} zIndex={1} isVisible={isVisible} />
      <P5Canvas sketch={drawingSketch} width={600} height={200} left={300} top={400}  zIndex={-1} isVisible={isVisible} />
      <P5Canvas sketch={drawingSketch} width={600} height={200} left={800} top={100}  zIndex={-1} isVisible={isVisible} />
